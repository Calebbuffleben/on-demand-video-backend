...
export declare class VideosController {
    ...
    constructor(videosService: VideosService, prismaService: PrismaService, muxWebhookController: MuxWebhookController, uploadService: UploadService, limitsService: LimitsService);
